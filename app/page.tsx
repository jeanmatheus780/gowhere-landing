...
function FeatureCard({ title, description }: { title: string; description: string }) {
  return (
    <div style={{ flex: "1 1 300px", padding: "1.5rem", border: "1px solid #eee", borderRadius: "10px", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" }}>
...
function TestimonialCard({ name, text }: { name: string; text: string }) {
  return (
    <div style={{ width: "300px", padding: "1rem", border: "1px solid #eee", borderRadius: "10px", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" }}>
      <h3>{name}</h3>
      <p>"{text}"</p>
    </div>
  );
